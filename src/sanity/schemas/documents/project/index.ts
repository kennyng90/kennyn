...
import { accessibleImageValidator } from "../../objects/accessible-image";
import { Schema } from "@/sanity/types/schema";

export default defineType({
  name: Schema.PAGE_PROJECT,
  title: "Projects",
  type: "document",
  ...
  fields: [
    ...
    defineField({
      ...
      description: "This is the image used to generate previews for this project",
      title: "Image",
      group: "content",
    ...
    defineField({
      type: Schema.IMAGE_GALLERY,
      title: "Image Gallery",
      description: "This is where you can upload images for a gallery",
      group: "content",
      name: "imageGallery",
    }),
  ],
